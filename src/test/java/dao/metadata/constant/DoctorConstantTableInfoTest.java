...
public class DoctorConstantTableInfoTest {
    private DoctorTableInfo tableInfo;
    private Properties tableProperties;
    private final String RESOURCE_PATH = "dao/tables/doctors.properties";

    public DoctorConstantTableInfoTest() {
        tableInfo = ConstantTableInfoFactory.getInstance().getDoctorTableInfo();
