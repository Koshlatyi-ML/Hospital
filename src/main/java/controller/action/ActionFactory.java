...
import controller.action.admin.medic.*;
...
public class ActionFactory {
    ...
    private ActionFactory() {
        ...
        actionMap.put("GET/admin/change-medic", new ChangeMedicGetAction(serviceFactory));
        actionMap.put("POST/admin/change-medic/move", new MoveMedicPostAction(serviceFactory));
        actionMap.put("POST/admin/change-medic/retire", new RetireMedicPostAction(serviceFactory));
